            ...
            <div className="card h-100 border-0">
                <div className="row no-gutters">
                    ...
                    <div className="col-md-8">
                        <div className="card-body" class="personal">
                            <h2 className="card-title">Personal Info</h2>
                            <p className="card-text"></p>
                            <p className="card-text">
                                <strong>Name:</strong> Iida Savimäki
                            </p>
                            <p className="card-text">
                                <strong>Email:</strong> iida.savimaki@hotmail.com
                            </p>
                            <p className="card-text">
                                <strong>Skills:</strong> JavaScript, HTML5, Wordpress, Java, Python and many more!
                            </p>
                            <p className="card-text">
                                <strong>About me:</strong> I am currently studying at Häme University of Applied Sciences, to become a Bachelor of Business Information Technology. I'm also a music play school teacher at Musiikkiteatteri Spektri. I love playing boardgames, crocheting and baking.
                            </p>
